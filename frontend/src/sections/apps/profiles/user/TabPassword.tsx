            ...
            <MainCard title="Change Password">
                <Formik
                    ...
                    onSubmit={async (values, { resetForm, setErrors, setStatus, setSubmitting }) => {
                        try {
                            await changePassword(values.old, values.password).then(() => {
                                resetForm();
                        ...
                        <form noValidate onSubmit={handleSubmit}>
                            <Grid container spacing={3}>
                                <Grid item container spacing={3} xs={12} sm={6}>
                                    <Grid item xs={12}>
                                        <Stack spacing={1.25}>
                                            <InputLabel htmlFor="password-old">Old Password <span style={{ color: 'red' }}>*</span></InputLabel>
                                            <OutlinedInput
                                    ...
                                    <Grid item xs={12}>
                                        <Stack spacing={1.25}>
                                            <InputLabel htmlFor="password-password">New Password <span style={{ color: 'red' }}>*</span></InputLabel>
                                            <OutlinedInput
                                    ...
                                    <Grid item xs={12}>
                                        <Stack spacing={1.25}>
                                            <InputLabel htmlFor="password-confirm">Confirm Password <span style={{ color: 'red' }}>*</span></InputLabel>
                                            <OutlinedInput
